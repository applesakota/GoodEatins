...
class DataSet {
    ...
    //MARK: - Creating Data For HomeViewController
    let categories = [
        ...
        FoodCategory(title: "Sandwitches", imageName: "sandwich0")
    ]
    
    
    //MARK: - Creating Data for burgers
    ...
    //MARK: - Creating Data for sandwiches
    ...
    ///Return specific array from category title
